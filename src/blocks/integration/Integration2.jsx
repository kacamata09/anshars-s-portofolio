      ...
      >
        <GraphicsCard
          sx={{
            ...
            backgroundColor: '#1C1C1C', // Menggunakan warna tema MUI
            color: 'white', // Warna teks
            boxShadow: 3, // Menambahkan bayangan
          }}>
          <Stack sx={{ alignItems: 'center', p: { xs: 3, sm: 4, md: 5 } }}>
            <Stack sx={{ alignItems: 'center', gap: { xs: 1, sm: 1.5 } }}>
              {headLine && (
                <Typography fontFamily={ 'GoodbyeDespair, Arial, sans-serif'} align="center" variant="h2">
                  {headLine}
                </Typography>
              )}
              {/* {captionLine && (

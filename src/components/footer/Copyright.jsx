...
export default function Copyright({ type = CopyrightType.TYPE1, isDivider = true }) {
  ...
  return (
    ...
    >
      <Typography variant="caption2" sx={{fontFamily: 'GoodbyeDespair, Arial, sans-serif', color: 'white' }}>
        Copyright © 2024
        <Link {...linkProps} href={branding.company.url} sx={{fontFamily: 'GoodbyeDespair, Arial, sans-serif', ...linkProps.sx, ml: 0.5 }}>

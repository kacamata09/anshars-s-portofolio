...
const navItemSX = {
  ...
  '&:hover': {
    backgroundColor: 'rgba(255, 255, 255, 0.1)', // Highlight saat hover
    ...
    <>
      {!item.megaMenu ? (
        <ListItemButton
          ...
          sx={{
            ...navItemSX,
            color: menuTextColor || 'rgba(255, 255, 255, 0.7)', // Warna teks default
          }}
        >
          <ListItemText
            primary={item.title}
            primaryTypographyProps={{
              variant: 'caption2',
              color: 'inherit', // Sesuaikan warna teks dengan hover
            }}
          />
        </ListItemButton>
      ) : (
...
function NavList({ item, menuTextColor }) {
  ...
  const toggleProps = {
    ...
    '&:hover': {
      color: 'white', // Warna teks saat hover
      backgroundColor: 'rgba(255, 255, 255, 0.1)', // Background saat hover
    },
  };
  const buttonProps = {
    sx: {

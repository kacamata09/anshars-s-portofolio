    ...
    <>
      ...
      <LazySection
        sections={[
          ...
          { importFunc: () => import('@/blocks/about').then((module) => ({ default: module.About9 })), props: aboutme },
          ...
          { importFunc: () => import('@/blocks/contactme').then((module) => ({ default: module.ContactMe })), props: contactme },
        ]}
        offset="200px"
        />
